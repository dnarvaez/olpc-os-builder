...
if arm is not None:
    repos["arm"] = ("mirrorlist", "http://mirrorlist.fedora-arm.wantstofly.org/?repo=fedora-%s&arch=armv5tel" % fver)
if olpc_arm is not None:
    repos["olpc_arm"] = ("baseurl", "http://xs-dev.laptop.org/~dsd/repos/f12-arm-olpc")
